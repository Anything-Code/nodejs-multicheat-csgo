<template>
    <div v-scroll="refreshScrollTopOffset">
        <v-progress-linear
            height="4"
            class="ma-0"
            v-if="!housingsMounted || !categoriesMounted"
            :indeterminate="true"
        />
        <v-container fluid v-if="housingsMounted && categoriesMounted">
            <h1 class="headline mb-3">Reise erstellen</h1>
                    ...
                    <v-flex :class="$vuetify.breakpoint.mdAndUp ? 'pl-2' : ''" xs12 md3>
                        ...
                        >
                            <v-menu
                                ...
                                v-model="beginningDatePickerMenu"
                                :nudge-right="33"
                                :nudge-bottom="10"
                                lazy
                            ...
                            >
                                <v-text-field
                                    ...
                                    readonly
                                />
                                <v-date-picker header-color="grey darken-2" v-model="beginningDate" @input="beginningDatePickerMenu = false" locale="DE-de" />
                            </v-menu>
                            <v-menu
                                :close-on-content-click="false"
                            ...
                            >
                                <span v-if="!mainLoading">Reise erstellen</span>
